    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(default='school', help_text='Material icon name', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('assigned_judges', models.ManyToManyField(blank=True, related_name='assigned_events', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_percent', models.DecimalField(decimal_places=1, help_text='Weight as percentage e.g. 20.0', max_digits=5)),
